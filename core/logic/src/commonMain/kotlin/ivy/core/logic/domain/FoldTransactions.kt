...
private data class FinancialDataState(
    val incomes: MutableMap<ivy.core.logic.data.AssetCode, Double> = mutableMapOf(),
    val expenses: MutableMap<ivy.core.logic.data.AssetCode, Double> = mutableMapOf(),
...
private fun MutableMap<ivy.core.logic.data.AssetCode, Double>.aggregateByAsset(
    value: MonetaryValue
) {
